...
import { ErrorMessage } from "./signup-form"
import { useRouter } from "next/navigation"
import { useForm } from "react-hook-form"
import { safeSignInSchema, SafeSignInSchemaType, safeSignUpSchema } from "@repo/common/types"
...
export function LoginForm({
  ...
  const signinMutation = useMutation({
      mutationFn: (data: SafeSignInSchemaType) => userSignInApi(data.email, data.password),
      onMutate: () => {
      ...
      onError: (error: AxiosError<ErrorMessage>, variables, context) => {
        ...
        toast.dismiss(context!.id);
        toast.error(message);
        console.log("Signin failed: ", message)
      },
  })
  
  function signinMutationHandler(data: SafeSignInSchemaType){
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(signinMutationHandler)}>
            <FieldGroup>
              {/* <Field>
