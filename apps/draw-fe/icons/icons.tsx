...
export const TriangleIcon = ({className}: ClassName) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" 
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
      className={cn(className)}>
...
export const DeleteIcon = ({className}: ClassName) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={cn(className)} width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" >
      <path d="M10 11v6"/>
      <path d="M14 11v6"/>
